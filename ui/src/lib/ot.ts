...
const OT_SCALAR_ORDER = BigInt('0x1000000000000000000000000000000014def9dea2f79cd65812631a5cf5d3ed');
 ...
 */
export function blindedChoice(pointABytes: Uint8Array, choice: number): { pointBBytes: Uint8Array, scalarB: bigint } {
 ...
 */
export async function tryDecrypt(pointABytes: Uint8Array, scalarB: bigint, ct: Uint8Array): Promise<Uint8Array> {
    const A = ristretto255.Point.fromBytes(pointABytes);
    ...
    try {
        ...
        throw new Error(`tryDecrypt failed: ${err}`);
    }
}

export async function decrypt(pointABytes: Uint8Array, scalarB: bigint, ciphertexts: Uint8Array[], choice: number): Promise<Uint8Array> {
